...
const heading = React.createElement(
  "div",
  { id: "parent" },
 [ React.createElement("div", { id: "child" ,key:"f"}, [
    React.createElement("h1", {key:"a"
    }, "h1 tag "),
    React.createElement("h2", {key:"b"}, "h2 tag"),
  ]),React.createElement("div", { id: "child",key:"c" }, [
    React.createElement("h1", {key:"d"}, "h1 tag "),
    React.createElement("h2", {key:"e"}, "h2 tag"),
  ])]
);
const A =()=><h1>rohit kumar ssahoo</h1>

const How= function(){
    return <div><A></A><h1>rohit functional component</h1></div>
}
